...
export const ITEMS: Item[] = [
  ...
  { id: 'm_o_4', name: '오버핏 윈드브레이커', category: 'outer', semantics: ['Active', 'Street'], image: 'https://images.unsplash.com/photo-1548883354-94bcfe321cbb?auto=format&fit=crop&q=80&w=300', gender: 'male', color: 'Black' },
  ...
  { id: 'm_b_3', name: '와이드 슬랙스', category: 'bottoms', semantics: ['Urban', 'Relaxed'], image: 'https://images.unsplash.com/photo-1622445272461-c6580cab8755?auto=format&fit=crop&q=80&w=300', gender: 'male', color: 'Black' },
  ...
  { id: 'f_o_2', name: '빈티지 청자켓', category: 'outer', semantics: ['Active', 'Urban'], image: 'https://images.unsplash.com/photo-1576995853123-5a10305d93c0?auto=format&fit=crop&q=80&w=300', gender: 'female', color: 'Denim' },
