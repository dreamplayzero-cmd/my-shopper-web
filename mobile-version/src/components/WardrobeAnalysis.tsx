                ...
                <header className="flex flex-col gap-10 items-center">
                  <div className="w-full max-w-[240px] aspect-[4/5] bg-surface-container-low rounded-[2rem] overflow-hidden group relative border border-outline-variant/10 shrink-0">
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="bg-white/10 backdrop-blur-xl p-3 rounded-xl border border-white/20 relative">
                        ...
                        <p className="absolute bottom-1 right-2 text-[4px] text-white/40 italic">
                          * 출처: 요하네스 이텐(Johannes Itten)의 색채 대비 이론
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-full bg-primary/5 border border-primary/20 rounded-3xl p-6 text-center flex flex-col items-center gap-3 shadow-sm mx-auto max-w-sm relative pb-8">
                    ...
                    <p className="absolute bottom-3 right-5 text-[6px] text-on-surface-variant/40 italic">
                      * 출처: 기상청 Open API 및 KOTITI 시험연구원 공공데이터
                    </p>
                  </div>
