                ...
                {previewPersona && (
                    ...
                    >
                        <motion.div 
                           ...
                           className="relative w-full max-w-sm max-h-[85vh] flex flex-col rounded-3xl overflow-hidden bg-surface shadow-2xl"
                           onClick={(e) => e.stopPropagation()}
                        >
                            <div className="overflow-y-auto w-full no-scrollbar">
                                <img src={previewPersona.image} alt={previewPersona.mood} className="w-full h-[45vh] md:h-auto md:aspect-[3/4] object-cover object-top shrink-0" />
                                <div className="p-5 text-center shrink-0">
                                    ...
                                    <p className="text-xs text-on-surface-variant uppercase tracking-widest mb-5">{previewPersona.category}</p>
